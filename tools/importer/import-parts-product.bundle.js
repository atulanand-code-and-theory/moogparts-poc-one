...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-parts-product.js
  var import_parts_product_exports = {};
  __export(import_parts_product_exports, {
    default: () => import_parts_product_default
  });
  ...
  var hasText3 = (el) => !!el && (el.textContent || "").trim().length > 0;
  ...
  var import_parts_product_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_parts_product_exports);
})();
