...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-technologies.js
  var import_technologies_exports = {};
  __export(import_technologies_exports, {
    default: () => import_technologies_default
  });
  ...
  var import_technologies_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_technologies_exports);
})();
