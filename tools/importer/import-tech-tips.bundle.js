...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-tech-tips.js
  var import_tech_tips_exports = {};
  __export(import_tech_tips_exports, {
    default: () => import_tech_tips_default
  });
  ...
  var PAGE_TEMPLATE = {
    "name": "tech-tips",
    "description": "Tech Tips listing page: a page title followed by an article-teaser card grid (image + title + excerpt + Read More) with a View More button.",
    "urls": [
      "https://www.moogparts.com/technical/bulletins/tech-tips.html"
    ],
    "blocks": [
      {
        "name": "hero-overlay",
  ...
  return __toCommonJS(import_tech_tips_exports);
})();
